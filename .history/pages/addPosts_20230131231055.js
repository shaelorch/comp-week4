  ...
  <h1>Write A Post</h1>
        ...
        <form onSubmit={handleSubmit} style={{display: "flex", flexDirection: "column", width:400}}>
          ...
          <textarea style={{backgroundColor:'white'}} value={content} onChange={(e) => setContent(e.target.value)} />
            ...
            <button style={{backgroundColor:'orange', borderRadius:10, border:'transparent', height:100}} type="submit">Submit</button>
        </form>
        <a href='/'>
            <button style={{display:'flex', marginTop:20, backgroundColor:'orange', border:'transparent', borderRadius:10}}>Go To Feed</button>
        </a>
