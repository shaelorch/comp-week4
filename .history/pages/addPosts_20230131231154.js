...
export default function Home({posts}) {
  ...
  <h1>Write A Post</h1>
        ...
        <a href='/'>
            <button style={{display:'flex', marginTop:20, backgroundColor:'orange', border:'transparent', height:30, alignItems:'center', borderRadius:10, padding:10}}>Go To Feed</button>
        </a>
