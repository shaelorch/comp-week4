...
export default function Home({posts}) {
  ...
  <h1 >Write A Post</h1>
        ...
        <form onSubmit={handleSubmit} style={{display: "flex", flexDirection: "column", width:400}}>
          <input style={{backgroundColor:'white', color:'black',marginTop:100, border:'transparent'}} type="text" value={title} onChange={(e) => setTitle(e.target.value)} />
          <textarea style={{color:'black',backgroundColor:'white'}} value={content} onChange={(e) => setContent(e.target.value)} />
